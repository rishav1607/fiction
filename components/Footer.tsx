    ...
    <footer className="border-t py-10">
      <div className="container">
        <div className="flex flex-col items-center gap-5">
          <div className="pt-2">
            <div className="h-9 w-9 grid place-content-center rounded-md ring-1 ring-border text-lg font-black select-none">F</div>
          </div>
          <nav className="flex items-center gap-6 text-sm opacity-90">
            ...
            <a className="hover:opacity-70" href="#">DMCA</a>
            <a className="hover:opacity-70" href="#">FAQ</a>
          </nav>
          <div className="opacity-90">
            <a aria-label="Discord" className="hover:opacity-100 opacity-70" href="#">
          ...
          <p className="text-sm opacity-70">© 2025 Fiction Realm. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
